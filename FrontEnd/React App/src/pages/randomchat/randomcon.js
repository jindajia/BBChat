    ...
    return (
        <ul ref={messageContainer} className='message-thread-container'>
            {conversations.map((conversation, index) => (
                <li
                    className={`message ${alignMessages(userDetails, conversation.toUserID) ? 'align-right' : ''
                        }`}
                    key={index}
                >
    ...
    return (
        <div className='app__conversion-container'>
            ...
            <div className='app__text-container'>
                <textarea
                    placeholder={`${selectedUser !== null ? '' : 'Select a user and'
